...
func FSCenterXConstraints (view: UIView, offset: CGFloat = 0) -> [NSLayoutConstraint] {
...
func FSProportionalHeightConstraints (view: UIView, multipler: CGFloat, constant: CGFloat) -> [NSLayoutConstraint] {
